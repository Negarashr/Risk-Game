...
@SpringBootTest
public class AggresivePlayerTest {
  ...
  public void testSuccessfulAttack() throws GameException {
    ...
    if (GameMap.getPlayer("pakistan") == GameMap.getPlayer("india")) {
      assertTrue(actualArmyPakistan > 0);
      assertTrue(actualArmyIndia > 0);
    } else {
      assertEquals(1, actualArmyPakistan);
    }
  }
}
